...
This section covers how to build and package Hourglass for production across all platforms.
...
Hourglass uses **semantic versioning** with optional pre-release tags.
